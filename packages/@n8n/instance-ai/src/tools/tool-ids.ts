...
export const RENDER_UI_TOOL_ID = DOMAIN_TOOL_IDS.RENDER_UI;
export const COLLECT_DECISION_TOOL_ID = DOMAIN_TOOL_IDS.COLLECT_DECISION;
...
export const ALWAYS_LOADED_TOOL_NAMES = new Set<string>([
	...
	DOMAIN_TOOL_IDS.RENDER_UI,
	DOMAIN_TOOL_IDS.COLLECT_DECISION,
